    ...
    def _fallback_help_center_articles(self) -> list[dict]:
        return [
            ...
            },
            {
                ...
                "content": (
                    "My Page에서는 무엇을 할 수 있나요?: 사용자 프로필 수정, 쇼핑몰 URL등록, 쇼핑몰 분위기 분석, 추천 이력 확인 기능을 이용할 수 있습니다.\n"
                    "My Page는 어디에서 들어가나요?: 상단 메뉴의 \"My\" 탭에서 접근할 수 있습니다.\n"
                    "프로필 수정은 어떻게 하나요?: 이름, 쇼핑몰 이름, 쇼핑몰 URL 등을 수정한 뒤 \"저장\" 버튼을 클릭하면 변경 내용이 저장됩니다.\n"
                    "쇼핑몰 분위기 분석은 무엇인가요?: 쇼핑몰 주소를 기반으로 AI가 브랜드 분위기와 스타일 키워드를 자동 분석하는 기능입니다.\n"
                    ...
                    "쇼핑몰 URL을 등록하지 않아도 추천 기능을 사용할 수 있나요?: 가능합니다. 다만 쇼핑몰 분위기 분석을 함께 사용하면 더 정확한 추천 결과를 받을 수 있습니다."
                ),
            },
            {
            ...
            {
                "title": "Recommendation 페이지 이용 안내",
                "content": (
                    "Recommendation 페이지에서는 무엇을 할 수 있나요?: 원하는 상품, 브랜드 분위기, 타겟 고객층에 맞는 인플루언서를 AI 기반으로 추천받을 수 있습니다.\n"
                    "Recommendation 페이지는 어디에서 이용하나요?: 상단 메뉴의 \"Recommend\" 탭에서 접근할 수 있습니다.\n"
                    "추천 요청은 어떻게 입력하나요?: 입력창에 브랜드 특징이나 원하는 인플루언서 조건을 자연어 형태로 입력하면 됩니다. 예시: \"20대 여성 대상 미니멀 패션 브랜드\", \"감성 카페 분위기의 디저트 브랜드\", \"운동 루틴 콘텐츠를 올리는 헬스 인플루언서\"\n"
                    "추천받기 버튼을 누르면 어떻게 되나요?: AI가 입력 내용을 분석하여 브랜드와 적합도가 높은 인플루언서를 추천합니다.\n"
                    "추천 결과 카드에는 어떤 정보가 표시되나요?: 프로필 이미지, 인플루언서 이름, 팔로워 수, 카테고리, 추천 점수 등이 표시됩니다.\n"
                    "추천 이유 보기 기능은 무엇인가요?: \"추천 이유 보기\" 버튼을 클릭하면 AI가 해당 인플루언서를 추천한 이유를 자연어 설명으로 제공합니다.\n"
                    "Recommendation 페이지의 필터 기능은 무엇인가요?: 카테고리, 팔로워 수, 스타일 키워드 기준으로 추천 결과를 세부 조정할 수 있습니다.\n"
                    "필터를 변경하면 추천이 다시 실행되나요?: 추천 결과 화면에서는 AI를 다시 실행하지 않고 즉시 필터링이 적용됩니다.\n"
                    "추천 결과가 너무 적게 나오는 이유는 무엇인가요?: 입력 조건이 너무 제한적이거나 특정 카테고리·팔로워 조건이 좁게 설정된 경우 추천 결과가 줄어들 수 있습니다.\n"
                    "추천 결과는 저장되나요?: 추천 실행 기록은 자동 저장되며 My Page에서 이전 추천 결과를 다시 확인할 수 있습니다.\n"
                    "추천 정확도를 높이려면 어떻게 해야 하나요?: 브랜드 분위기, 제품 특징, 타겟 고객층 등을 구체적으로 입력할수록 더 정확한 추천 결과를 받을 수 있습니다.\n"
                    "추천 결과에서 관심 인플루언서를 저장할 수 있나요?: 추천 카드의 별(★) 아이콘을 클릭하면 My Picks에 저장할 수 있습니다."
                ),
            },
            {
                "title": "회원가입 및 로그인 안내",
        ...
        with SessionLocal() as db:
            ...
            try:
                ...
                system_role = (
                    ...
                    "참고 데이터에는 Chatwoot Help Center의 다음 제목의 문서가 포함됩니다: '챗봇 및 상담원 이용 안내', 'My Picks의 기능 안내', 'Data Insights의 기능 안내', '추천 결과와 점수 안내', 'My Page 및 추천 이력 안내', '인플루언서 추천 기능 안내', '상담원 안내', '회원가입 및 로그인 안내', 'Recommendation 페이지 이용 안내'.\n"
