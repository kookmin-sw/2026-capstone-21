...
export async function getTotalSelections() {
  const res = await customFetch(`${BASE_URL}/total-selections`);
...
export async function getTopPerformer() {
  const res = await customFetch(`${BASE_URL}/top-performer`);
...
export async function getTotalInfluencers() {
  const res = await customFetch(`${BASE_URL}/total-influencers`);
...
export async function getDailyTrends() {
  const res = await customFetch(`${BASE_URL}/daily-trends`);
...
export async function getCategoryDistribution() {
  const res = await customFetch(`${BASE_URL}/category-distribution`);
