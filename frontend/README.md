...
6) insight api 연동 진행중 -> 2026-capstone-21/frontend/src/app/components/CompareInfluencers.tsx 에서 DB 기준 grade_score / followers, backend ranking 기반 계산 추가해서 수정함.
   2026-capstone-21/frontend/src/app/components/Analytics.tsx 에서 mock 데이터 제거 후 DB 기반 /insights/daily-trends, /insights/category-distribution,
/insights/total-selections, /insights/total-influencers 추가함.  --> insight api 연결은 끝난 상태
2026-capstone-21/frontend/src/app/components/CompareInfluencers.tsx <<< 두 인플루언서를 비교하는 기능인데 이건 아직 미완성
